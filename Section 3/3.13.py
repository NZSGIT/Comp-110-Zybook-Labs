...
caffiene = float(input())

print("After 6 hours: {:.2f} mg".format(caffiene/2))
print("After 12 hours: {:.2f} mg".format(caffiene * .25))
print("After 24 hours: {:.2f} mg".format(caffiene * .0625))
